            ...
            <main className={` ${howto.body}`}>
                ...
                <div className="accordion-item">
                    <h2 className="accordion-header" id="headingOne">
                        <button className={`accordion-button ${howto.buttonTitle} `} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                    ...
                    <h2 className="accordion-header" id="headingTwo">
                        <button className={`accordion-button ${howto.buttonTitle} `} type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                ...
                <ul>
                    <li >
                        <p className={`${howto.buttonTitle} `}><a href="https://luca.co.in/wp-content/uploads/2020/10/CovidPedia-LUCA-KSSP.pdf">കോവിഡ് 19 വിജ്ഞാന ശേഖരം</a></p>
                    </li>
                    <li >
                        <p className={`${howto.buttonTitle} `}><a href="https://luca.co.in/wp-content/uploads/2021/04/LUCA-VACCINEPEDIA.pdf">കോവിഡ് 19 വാക്സിൻ വിജ്ഞാന ശേഖരം </a></p>
                    </li>
                </ul>
