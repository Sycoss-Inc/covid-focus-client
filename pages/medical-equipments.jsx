              ...
              <div className="accordion-body">
                <ul>
                  ...
                  <li className={` ${howto.listItem}`}>
                    ...
                    എത്തുന്നുവെന്ന് എളുപ്പത്തിലും വേദനരഹിതമായും അറിയാനുള്ള
                    അളവാണ് ഇത്,”എന്ന് ജോൺ ഹോപ്കിൻസ് മെഡിസിൻ പറയുന്നു.
                  </li>
                  <li className={` ${howto.listItem}`}>
                    ...
                    ഓക്സിജൻ അളവ് സ്ഥിരമായി പരിശോധിക്കുന്നത് ശരീരത്തിൽ ഓക്സിജൻ
                    അളവ് കുറയുന്നുണ്ടോഎന്ന് അറിയാൻ സഹായിക്കും.
                  </li>
                  <li className={` ${howto.listItem}`}>
            ...
            >
              <div className="accordion-body">
                <ol>
                  ...
                  <li className={` ${howto.listItem}`}>
                    ഒരു മിനിറ്റ് അല്ലെങ്കിൽ റീഡിങ് കഴിയുന്നത് വരെ
                    കാത്തുനിൽക്കുക.
                  </li>
                  <li className={` ${howto.listItem}`}>
