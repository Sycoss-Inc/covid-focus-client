    ...
    <Layout title="Vaccination">
      ...
      <main className={style.stats}>
        <div className={style.sect1}>
          <h1 className={style.headin}>
            {" "}
            <strong>റജിസ്റ്റർ ചെയ്യേണ്ടത് ഇങ്ങനെ </strong>{" "}
          </h1>
          <ul className={`container`}>
            <h6>
              ...
              <br />{" "}
              <li>
                മൊബൈൽ ഫോൺ നമ്പര്‍ രേഖപ്പെടുത്തി ഒടിപി ലഭിക്കാന്‍ ക്ലിക്ക്
                ചെയ്യുക
              </li>
              <br />{" "}
              <li>
                മൊബൈലില്‍ ലഭിക്കുന്ന ഒടിപി നമ്പര്‍ വെബ്‌റ്റൈില്‍ രേഖപ്പെടുത്തി
                ‘വെരിഫൈ’ എന്നതില്‍ ക്ലിക്ക് ചെയ്യുക
              </li>
              <br />{" "}
              <li>
                തുടര്‍ന്ന് ‘രജിസ്‌ട്രേഷന്‍ വാക്‌സിനേഷന്‍’ പേജില്‍ പേര്, ലിംഗം,
                ജനന തിയതി, ഫൊട്ടൊ പതിച്ച തിരിച്ചറിയല്‍ കാര്‍ഡിലെ മറ്റു
                വിവരങ്ങള്‍ എന്നിവ രേഖപ്പെടുത്തി ‘രജിസ്റ്റര്‍’ എന്നതില്‍ ക്ലിക്ക്
                ചെയ്യുക
              </li>
              <br />{" "}
              <li>
                രജിസ്റ്റര്‍ ചെയ്തുകഴിഞ്ഞാല്‍, അപ്പോയിന്റ്‌മെന്റ് ഷെഡ്യൂളിനുള്ള
                ഓപ്ഷന്‍ ലഭിക്കും. രജിസ്റ്റര്‍ ചെയ്ത വ്യക്തിയുടെ പേരിന്
                അടുത്തുള്ള ‘ഷെഡ്യൂള്‍’ എന്നതില്‍ ക്ലിക്ക് ചെയ്യുക
              </li>
              <br />{" "}
              <li>
                നിങ്ങളുടെ പിന്‍ കോഡ് നല്‍കി തിരയുക. പിന്‍ കോഡിലെ കേന്ദ്രങ്ങള്‍
                ലഭ്യമാവുന്നതോടെ തിയതിയും സമയവും തിരഞ്ഞെടുത്ത് ‘കണ്‍ഫേം’
        ...
        <div className={style.vel}>
          ...
          <h6>
            ...
            രോഗികള്‍, അംഗപരിമിതര്‍ തുടങ്ങിയവര്‍ക്ക് ആദ്യഘട്ടത്തിൽ വാക്സിൻ നൽകാൻ
            തീരുമാനിച്ചിരിക്കുന്നു. ഓൺലൈൻ അപേക്ഷകൾക്കായി താഴെ നൽകിയിരിക്കുന്ന
            ...
            <ol>
              ...
              <li>
                {" "}
                <a href="https://www.cowin.gov.in/">www.cowin.gov.in/</a> എന്ന
                വെബ്സൈറ്റ് സന്ദർശിക്കുക. തിരിച്ചറിയൽ രേഖയും വ്യക്തിഗത വിവരങ്ങളും
                നൽകി രജിസ്റ്റർ ചെയ്യുക.
              </li>
              <br />{" "}
              <li>
                Add more എന്ന ഓപ്ഷൻ നൽകി ഒരു മൊബൈൽ നമ്പറിൽ നിന്നും നാലു പേർക്ക്
                വരെ രജിസ്റ്റർ ചെയ്യാം.
              </li>
              <br />{" "}
              <li>
                <a href="https://covid19.kerala.gov.in/vaccine/">
                  https://covid19.kerala.gov.in/vaccine/
                </a>{" "}
                എന്ന വെബ്സൈറ്റിൽ നിങ്ങളുടെ വിവരങ്ങൾ നൽകുക.
              </li>
              <br />{" "}
              <li>
                രോഗാവസ്ഥ വ്യക്തമാക്കുന്ന സർട്ടിഫിക്കറ്റ് അറ്റാച്ച് ചെയ്യുക.
              </li>
              <br />{" "}
              <li>
                നൽകിയ വിവരങ്ങൾ ജില്ലാ തലത്തിൽ പരിശോധിച്ചതിനു ശേഷം രോഗാവസ്ഥയുടെ
                മുൻഗണനയും വാക്സിന്റെ ലഭ്യതയും അനുസരിച്ച് വാക്സിനേഷൻ ലഭ്യമാകുന്ന
                സ്ഥലവും തീയതിയും എസ്.എം.എസ് വഴി അറിയിക്കുന്നതാണ്.
              </li>
            </ol>
          </h6>
          <br />
